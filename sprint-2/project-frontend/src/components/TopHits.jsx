...
function TopHits() {
    ...
    const songs = [
        ...
        { id: 5, title: 'Song One', imgSrc: 'https://via.placeholder.com/150' },
        { id: 6, title: 'Song Two', imgSrc: 'https://via.placeholder.com/150' },
        { id: 7, title: 'Song Three', imgSrc: 'https://via.placeholder.com/150' },
        { id: 8, title: 'Song Four', imgSrc: 'https://via.placeholder.com/150' },
        { id: 9, title: 'Song Four', imgSrc: 'https://via.placeholder.com/150' },
        { id: 10, title: 'Song One', imgSrc: 'https://via.placeholder.com/150' },
        { id: 11, title: 'Song Two', imgSrc: 'https://via.placeholder.com/150' },
        { id: 12, title: 'Song Three', imgSrc: 'https://via.placeholder.com/150' },
        { id: 13, title: 'Song Two', imgSrc: 'https://via.placeholder.com/150' },
        { id: 14, title: 'Song Three', imgSrc: 'https://via.placeholder.com/150' },
    ];
